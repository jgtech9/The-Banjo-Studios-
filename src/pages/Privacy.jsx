    ...
    <div>
      ...
      <section className="relative py-24 sm:py-28 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="reveal text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">
            Privacy Policy
          </h1>
          <p className="reveal text-sm text-gray-500 dark:text-gray-400" style={{ animationDelay: '100ms' }}>
